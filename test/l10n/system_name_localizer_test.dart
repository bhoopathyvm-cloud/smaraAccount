...
void main() {
  test('unchanged seed names map through AppLocalizations; custom names pass through', () {
  ...
  test('Tamil maps an unchanged seed name to the Tamil ARB label', () {
    ...
    expect(ta.systemGroupCashEquivalents, isNot(equals(kSystemGroupCashEquivalents)));
  });
}
