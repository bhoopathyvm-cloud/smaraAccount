...
/// Settings screen exporting an optional, passphrase-protected keystore
/// file backup of the current signing key (spec: "Optional Recovery and
/// Backup Setup"), reachable at any time.
class KeystoreExportView extends StatefulWidget {
  const KeystoreExportView({super.key, required this.viewModel});
