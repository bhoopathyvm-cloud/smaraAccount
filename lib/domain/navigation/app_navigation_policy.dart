...
class AppNavigationPolicy {
  ...
  Future<String?> resolve(String matchedLocation) async {
    ...
    if (identity == null) {
      // First launch: language comes before currency. Both are valid
      // pre-identity so the user can move language -> currency; the currency
      // screen's own commitIdentity is what ends the pre-identity phase.
