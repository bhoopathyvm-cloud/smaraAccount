...
/// Buy / sell / dividend posting: validation, legs, lot/sell rows, and
/// brokerage follow-up. Constructed by [InvestmentRepository] (same
/// facade pattern as [LedgerPosting] inside [LedgerRepository]).
class InvestmentTradePosting {
  InvestmentTradePosting({
