...
Flutter-free draft module for the transfer form: cross-currency visibility, fee-deducted transfer amount, implied rate, and submit readiness — owned outside the ViewModel.
