...
The app is a genuinely supported, working Flutter target on Linux desktop, not just a claim: it builds, launches, and its core onboarding/identity flows work, validated via a GitHub Actions Linux runner.
