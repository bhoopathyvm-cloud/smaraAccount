...
Flutter- and Drift-free investment lot replay, scaled quantity×price math, and quote valuation — shared by holdings UI drafts and data loaders without domain→data imports.
