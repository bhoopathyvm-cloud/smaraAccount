...
The Android application module compiles against an SDK version that satisfies every bundled plugin's floor, with the pin documented and reversible when Flutter's default catches up.
