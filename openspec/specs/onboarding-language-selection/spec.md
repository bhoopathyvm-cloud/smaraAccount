...
A mandatory first-screen language picker on first launch, before any other onboarding step, with a language-derived currency default and immediate, persisted effect on the running app.
