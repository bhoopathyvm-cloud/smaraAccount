...
Android release builds are signed with a dedicated upload keystore whose secrets stay out of version control, and a missing key fails the build instead of silently using the debug certificate.
