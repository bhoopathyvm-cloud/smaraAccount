...
The iOS app's App Store Connect submission declares its actual export-compliance and required-reason API usage, consistent with the public privacy policy.
