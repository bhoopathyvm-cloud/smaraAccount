# locales-indian-north

## Purpose

UI locale pack for Northern Indian languages (Hindi, Urdu, Punjabi, Nepali, Sanskrit, Dogri, Kashmiri, Maithili).
...
- **THEN** home, add spent/received, and error messages the user sees resolve from `app_hi.arb`
