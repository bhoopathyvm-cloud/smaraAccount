...
The macOS App Store release build runs under App Sandbox with the minimum entitlements needed for signing-key storage, file import/export, and biometric unlock.
