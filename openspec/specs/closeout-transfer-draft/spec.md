# closeout-transfer-draft

## Purpose

Flutter-free archived-account closeout form state (destination account and
currency, date, description, destination amount) that derives
cross-currency status and the amount to submit, owned by the register
closeout dialog.
