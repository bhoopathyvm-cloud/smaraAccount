...
- [x] 1.2 Rewrite the settle screen's intro/fee copy to the same voice, hiding FX-settlement jargon - `settle_pending_transfer_view.dart`: app bar title "What arrived?", the same "You sent X to Y" sentence as Home, "Tell us what actually arrived." instead of "Provisional: ...", amount field labeled "Amount that arrived", and the shortfall copy reworded from "Shortfall: ... - choose a category to cover it." to "You received X less than expected - choose a category to cover the difference."
