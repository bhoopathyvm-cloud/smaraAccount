...
- [ ] 1.1 Generate AI translations into `app_ja.arb`, `app_zh.arb`, `app_ko.arb` (preserve keys, placeholders, `@` metadata; use the foundation glossary). Chinese copy is Simplified.
