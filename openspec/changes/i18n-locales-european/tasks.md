...
- [ ] 1.1 Generate AI translations into `app_de.arb`, `app_fr.arb`, `app_es.arb`, `app_it.arb`, `app_pt.arb`, `app_hu.arb`, `app_ro.arb` (preserve keys, placeholders, `@` metadata; use the foundation household glossary)
...
- [ ] 3.1 Smoke-test German and French on Home and a dialog-heavy screen such as Add spent (check overflow)
